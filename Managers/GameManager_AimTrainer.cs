...
{
    public static PlayerInput playerInput; //New input system
    ...
    private int playerScore, timeRemaining, gameTime;
    ...
    void scoreFade(int number) //Creates score popup effect, score obj has animator that resets on disable
    {
