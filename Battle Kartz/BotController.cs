...
//One of my oldest projects, but I made a fully autonomous bot that drives around a 3D map, and uses powerups! Could use a lot of optimization, but it works.
//Cool stuff here: checkpoint system, powerups, drifting and nitro mechanics.
public class BotController : MonoBehaviour {
    ...
    void Start () //If you have to see this, I'm sorry.
    {
    ...
    bool GroundDetection () //Detects if kart is on the ground
    {
    ...
    public void Respawn() //Teleports the kart to the last checkpoint
    {
    ...
    //Bot powerups, simpler than player ones
