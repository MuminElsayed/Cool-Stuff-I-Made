...
//This is my first ever PlayerController and code with C#, I will leave it here with all its glory.
public class NewKartController : MonoBehaviour 
{
	...
	void FixedUpdate () 
	{
        // rigidBody.AddForce(Vector3.down * gravity, ForceMode.Acceleration); //Gravity
        Gravity(); //The cooler gravity
    ...
    float Airtime () //Used in nitro boost on landing
    {
...
//        Debug.Log("Drifting Movement");
    ...
    public void UpdatePosition() //Creates custom int to compare player distances with each other -> Can be changed to bytes
    {
