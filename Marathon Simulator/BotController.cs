...
//An infinite running bot that also takes 90 degree turns and disappears when gone too far.
public class BotController : MonoBehaviour
{
    ...
    {
        int rightAngle = Mathf.RoundToInt(currentAngle/90f) * 90; //Make sure it's really 90 degrees
